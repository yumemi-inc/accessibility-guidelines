...
<Aside type="caution">
フォーカスが見えないと、キーボードユーザーは今どの要素にいるのか把握できず、意図しない操作や混乱の原因になります。
</Aside>
...
- [ ] **フォーカスのコントラスト**が背景よりはっきり見える（目安として3:1。薄い色なら濃くする）
...
- [WCAG 2.2 達成基準 2.4.7 フォーカスの可視化](https://www.w3.org/WAI/WCAG22/Understanding/focus-visible.html)（レベルAA）
- [WCAG 2.2 達成基準 2.4.11 フォーカス表示（最小）](https://www.w3.org/WAI/WCAG22/Understanding/focus-appearance-minimum.html)（レベルAA）
