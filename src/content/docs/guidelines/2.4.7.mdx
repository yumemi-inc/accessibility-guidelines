...
<LiveCodeExample
  html={`<button class="button">ボタン1</button>
<button class="button">ボタン2</button>
<a href="#" class="link">リンク</a>`}
  css={`/* アクセシビリティ上問題があるスタイル */
.button:focus {
...
<button class="button">ボタン2</button>
<a href="#" class="link">リンク</a>`}
  css={`/* outline-offsetで要素から離れた位置に表示 */
.button:focus-visible {
